		...
		<div class="form-item cf">
			...
			<div class="controls">
				<select name="region_id">
					...
					<?php $_result=get_region_list();if(is_array($_result)): $i = 0; $__LIST__ = $_result;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><option value="<?php echo ($vo["id"]); ?>"><?php echo ($vo["region_name"]); ?></option><?php endforeach; endif; else: echo "" ;endif; ?>
				</select>
			</div>
		</div>
        <div class="form-item">
            ...
            <div class="controls">
                <input type="text" class="text input-large" name="store_name" value="<?php echo ((isset($info["store_name"]) && ($info["store_name"] !== ""))?($info["store_name"]):''); ?>">
            </div>
        </div>
        <div class="form-item">
...
<script type="text/javascript" charset="utf-8">
	...
	Think.setValue('region_id',<?php echo ((isset($info["region_id"]) && ($info["region_id"] !== ""))?($info["region_id"]):0); ?>);
	console.log(<?php echo ((isset($info["region_id"]) && ($info["region_id"] !== ""))?($info["region_id"]):0); ?>);
