...
<body>
	...
	<div class="cf">
		<div class="fl">
            <a class="btn" href="<?php echo U('Classes/add');?>">新 增</a>
    ...
    <tbody>
		<?php if(!empty($_list)): if(is_array($_list)): $i = 0; $__LIST__ = $_list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
			...
			<td>
				...
				<?php else: ?>
				<a href="<?php echo U('Classes/changeStatus?method=resumeClasses&id='.$vo['id']);?>" class="ajax-get">启用</a><?php endif; ?>
				<a href="<?php echo U('Classes/changeStatus?method=deleteClasses&id='.$vo['id']);?>" class="confirm ajax-get">删除</a>
                </td>
