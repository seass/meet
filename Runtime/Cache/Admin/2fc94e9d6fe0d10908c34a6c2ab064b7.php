...
<body>
	...
	<div class="main-title cf">
		<h2><?php echo isset($info['id'])?'编辑':'新增';?>大区</h2>
	</div>
<form action="<?php echo U();?>" method="post" class="form-horizontal">
        <div class="form-item">
            <label class="item-label">大区名称<span class="check-tips"></span></label>
            <div class="controls">
                <input type="text" class="text input-large" name="region_name" value="<?php echo ((isset($info["region_name"]) && ($info["region_name"] !== ""))?($info["region_name"]):''); ?>">
            </div>
        </div>
        <div class="form-item">
