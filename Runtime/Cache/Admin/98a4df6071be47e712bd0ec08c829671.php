...
<body>
	...
	<div class="cf">
		...
		<div class="search-form fr cf">
			<div class="sleft">
				<input type="text" name="_key" class="search-input" value="<?php echo I('_key');?>" placeholder="请输入门店名称/大区名称">
    ...
    <tbody>
		<?php if(!empty($_list)): if(is_array($_list)): $i = 0; $__LIST__ = $_list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
			...
			<td>
				<a href="<?php echo U('store/edit?id='.$vo['id']);?>">编辑</a>
				<?php if($vo["status"] == 1): ?><a href="<?php echo U('Store/changeStatus?method=forbidStore&id='.$vo['id']);?>" class="ajax-get">禁用</a>
				<?php else: ?>
				<a href="<?php echo U('Store/changeStatus?method=resumeStore&id='.$vo['id']);?>" class="ajax-get">启用</a><?php endif; ?>
				<a href="<?php echo U('Store/changeStatus?method=deleteStore&id='.$vo['id']);?>" class="confirm ajax-get">删除</a>
                </td>
