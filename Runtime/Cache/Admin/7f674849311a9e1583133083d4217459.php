...
<body>
	...
	<div class="main-title cf">
		<h2><?php echo isset($info['id'])?'编辑':'新增';?>班级</h2>
	</div>
<form action="<?php echo U();?>" method="post" class="form-horizontal">
        ...
        <div class="form-item">
            ...
            <div class="controls">
                <input type="text" class="text input-large" name="classes_name" value="<?php echo ((isset($info["classes_name"]) && ($info["classes_name"] !== ""))?($info["classes_name"]):''); ?>">
            </div>
        </div>
        <div class="form-item">
