...
<body>
	...
	<div class="cf">
		<div class="fl">
            <a class="btn" href="<?php echo U('Meet/add');?>">新 增</a>
		...
		<div class="search-form fr cf">
			<div class="sleft">
				<input type="text" name="_key" class="search-input" value="<?php echo I('_key');?>" placeholder="请输入会议名称">
    ...
    //导航高亮
    highlight_subnav('<?php echo U('Meet/index');?>');
	</script>
