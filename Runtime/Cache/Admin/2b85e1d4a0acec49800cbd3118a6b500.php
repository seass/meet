...
<body>
	...
	<div class="main-title cf">
		<h2><?php echo isset($info['id'])?'编辑':'新增';?>会议</h2>
	</div>
<form action="<?php echo U();?>" method="post" class="form-horizontal">
        <div class="form-item">
            <label class="item-label"><span style="color:red;">*</span> 会议名称<span class="check-tips">（必填）</span></label>
            <div class="controls">
                <input type="text" class="text input-large" name="meet_name" value="<?php echo ((isset($info["meet_name"]) && ($info["meet_name"] !== ""))?($info["meet_name"]):''); ?>">
            </div>
        </div>
        <div class="form-item cf">
			<label class="item-label">会议须知<span class="check-tips">（输入会议须知）</span></label>
			<div class="controls">
				<label class="textarea input-large"><textarea name="hyxz"><?php echo ($info["hyxz"]); ?></textarea></label>
			</div>
		</div>
		<div class="form-item cf">
			<label class="item-label">日程安排<span class="check-tips">（输入日程安排）</span></label>
			<div class="controls">
				<label class="textarea input-large"><textarea name="rcap"><?php echo ($info["rcap"]); ?></textarea></label>
			</div>
		</div>
		<div class="form-item cf">
			<label class="item-label">工作人员信息<span class="check-tips">（输入工作人员信息）</span></label>
			<div class="controls">
				<label class="textarea input-large"><textarea name="gzry"><?php echo ($info["gzry"]); ?></textarea></label>
			</div>
		</div>
		<div class="form-item cf">
			<label class="item-label">住宿安排<span class="check-tips">（输入住宿安排）</span></label>
			<div class="controls">
				<label class="textarea input-large"><textarea name="zsap"><?php echo ($info["zsap"]); ?></textarea></label>
			</div>
		</div>
		<div class="form-item cf">
			<label class="item-label">车辆安排<span class="check-tips">（输入车辆安排）</span></label>
			<div class="controls">
				<label class="textarea input-large"><textarea name="car"><?php echo ($info["car"]); ?></textarea></label>
			</div>
		</div>
		<div class="form-item cf">
			<label class="item-label">用餐安排<span class="check-tips">（输入用餐安排）</span></label>
			<div class="controls">
				<label class="textarea input-large"><textarea name="food"><?php echo ($info["food"]); ?></textarea></label>
			</div>
		</div>
        <div class="form-item">
